...
class ClientController extends AbstractController
{
    ...
    /**
     * @Route("/all", name="app_client", methods={"GET"})
     */
     ...
     */
    public function show(Client $client, RdvRepository $rdvRepository, SocieteRepository $societeRepository): Response
    {
        return $this->render('client/show.html.twig', [
            'client' => $client,
            'rdv' => $rdvRepository->findBy(['client' => $client]),
//            'societes' => $societeRepository->findBy(['clients' => [$client]])
        ]);
    }
